...
<div class="container cat_container">
    ...
    <form>
        ...
        <div class="row">
            ...
            <div class="col-8 pro_inputs">
                <div class="form-group">
                    <label for="inputEmail4" class="pro_labels">Address</label>
                    <input type="email" class="form-control" id="inputEmail4" placeholder="Email">
                </div>
            </div>
            <div class="col-12 pro_inputs">
                <div class="form-group">
                    <label for="exampleFormControlTextarea1" class="pro_labels">Example textarea</label>
